...
1.2. Based on the input number, update the 'answers' array property. For example, if the option is 3, increase the value at
position 3 of the array by Make sure to check if the input is a number and if the number makes sense 
